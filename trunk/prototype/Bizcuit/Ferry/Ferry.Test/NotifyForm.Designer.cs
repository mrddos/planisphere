namespace Ferry.Test
{
	partial class NotifyForm
	{
		...
		private void InitializeComponent()
		{
			...
			// buttonDisconnect
			// 
			this.buttonDisconnect.Location = new System.Drawing.Point(203, 108);
			this.buttonDisconnect.Name = "buttonDisconnect";
			this.buttonDisconnect.Size = new System.Drawing.Size(119, 30);
			this.buttonDisconnect.TabIndex = 3;
			this.buttonDisconnect.Text = "Disconnect";
			this.buttonDisconnect.UseVisualStyleBackColor = true;
			this.buttonDisconnect.Click += new System.EventHandler(this.ButtonDisconnect_OnClick);
			// 
			// NotifyForm
			// 
