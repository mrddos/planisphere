        ...
        private class QuadNode
        {
            ...
            public IEnumerable<Tuple<QuadNode, double>> GetNodesIntersecting(Rect bounds)
            {
                ...
                do
                {
                    ...
                    {
                        yield return Tuple<QuadNode, double>.Create(n, n != this ? n.Next.Priority : double.NaN);
                    }
                } while (n != this);
            }
                ...
                while (queue.Count > 0)
                {
                    ...
                    if (enumerator.MoveNext())
                    {
                        ...
                        if (newPotential > node.Priority)
                        {
                            ...
                            var store = Enumerable.Repeat(Tuple < QuadNode, double>.Create(node, double.NaN), 1).GetEnumerator();
                        ...
                        else
                        {
                            ...
                            yield return Tuple<QuadNode, double>.Create(node, newPotential);
                        }
